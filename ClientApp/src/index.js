        ...
        return (
            <div className="mainBody">
                ...
                <div className="inputLine">
                    ...
                    <nobr className="text">
                        1 Freddo : 
                        {` ${(this.state.costPs * this.state.currentExchangeRate).toFixed(2)} ${this.state.currency}`}
                    </nobr>&nbsp;&nbsp;
...
async function getChangeObj() {
    return fetchJSON(`${APIOrigin}ChangePoints`)
...
async function getCurrencyOptions() {
    return fetchJSON(`${APIOrigin}CurrencyValues`)
